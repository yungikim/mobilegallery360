        ...
        children: [
          Expanded(
            child: ImageLoadCache(
              ...
              height: 200,
              url:
              "https://www.gallery360.co.kr/artimage/${state2.artists[index].email}/art/preview/${state2.artists[index].avatar}.jpg",
            ),
          ),
          Container(
              width: width * 0.49,
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  ...
                  image: NetworkImage(
                      "https://www.gallery360.co.kr/artimage/${state2.artists[index].email}/photo_list/${state2.artists[index].email}_gray.jpg" ??
                          ""),
                  fit: BoxFit.cover,
                ),
              ),
